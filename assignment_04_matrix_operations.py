...
def main():
    ...
    rows_a = int(input("Enter Matrix A rows: "))
    cols_a = int(input("Enter Matrix A columns: "))

    matrix_a = read_matrix(rows_a, cols_a)

    rows_b = int(input("Enter Matrix B rows: "))
    cols_b = int(input("Enter Matrix B columns: "))
